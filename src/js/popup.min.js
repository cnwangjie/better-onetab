(function(){document.title=chrome.i18n.getMessage("extName");var p=$("body");var t=$(".js-dblclick-btn");var n=$(".js-searcher");var s=null;p.attr("data-lan",chrome.i18n.getMessage("@@ui_locale"));
...
$("#rightMenu li.uninstall").html(chrome.i18n.getMessage("rightUninstall"));$("#rightMenu li.homepage").html(chrome.i18n.getMessage("rightHomepage"));t.html(chrome.i18n.getMessage("closeAllBtn"));
n.attr("placeholder",chrome.i18n.getMessage("searcherPlaceholder"));var b=$("#tips .url");b.html(chrome.i18n.getMessage("tipsUrl"));b.attr("href",b.attr("href")+chrome.i18n.getMessage("@@ui_locale"));
var d=$("#showList");var q=$("#hideList");var e=$("#wrap");var k=localStorage.getItem("_switch_show_extname_")!=="close";var w=localStorage.getItem("_switch_right_more_")!=="close";
var l=$("#extName");var h=$("#rightMenu");var z="#5c5e6f";var y="../icon/default-icon.png";var j={4:304,5:380,6:456,7:532,8:608,9:684};e.width(j[localStorage.getItem("_showColumn_")]);
