...
if(x.length===0){b.addClass("allListIsEmpty");}}c.html(p.join(""));setTimeout(function(){$("body").css("background-color","#fff");b.height(b.height()+1);
},200);a();});}d();function a(){if(!localStorage.getItem("_switch_show_badge_")){var o=j();var n=0;$("#showList li").each(function(p,q){var r=$(q).data("id");
