...
if(i&&x.icons&&x.icons.length>0){(function(F,G){setTimeout(function(){a(F,G.id);},0);})(x.icons[0].url,x);}if(x.enabled===false){w.push(B);}else{if(A==="locked"){D.unshift(B);
...
M.removeClass("dinginess");}if(i){var A="right";var I=F.offset();var C=I.left+50-10;var K=C+f[o];var w=F.outerWidth();var H=F.outerHeight();var N=$("body").outerWidth();
